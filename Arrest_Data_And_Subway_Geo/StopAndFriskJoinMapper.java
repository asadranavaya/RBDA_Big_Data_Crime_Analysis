...
public class StopAndFriskJoinMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        final double latitude = Double.parseDouble(temp[3]);
        final double longitude = Double.parseDouble(temp[4]);
